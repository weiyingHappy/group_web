...
function NetDetail({ app, history, net, loading }) {
  ...
  return (
    <div>
      ...
      <div className={cs.whitebgp}>
        ...
        <EditableInput title="网点名称" value={detail.name} bindName="name" />
...
function mapStateToProps({ app, net, loading }) {
  return { net, loading, app }
}

export default connect(mapStateToProps)(NetDetail)
