...
function DeliveryList({ router, dispatch, history, delivery }) {
  const columns = [
    {
      title: '网点编号',
      dataIndex: 'id',
...
function mapStateToProps({ app, delivery }) {
  return { delivery, router: app.router }
}
